# Rijan Regmi Portfolio - Monorepo Architecture & Developer Guide

Unified **Next.js TypeScript** frontend with an **Express.js TypeScript & MongoDB** layered architecture backend.
...
│
├── public/                          # Static assets (images, PDFs, DOCX, icons)
