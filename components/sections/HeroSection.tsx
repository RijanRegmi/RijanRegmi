    ...
    <section id="home" className="relative w-full min-h-[90vh] sm:min-h-[880px] bg-gradient-to-b from-purple-50/50 via-white to-slate-50/80 flex flex-col justify-center pt-28 sm:pt-36 lg:pt-32 pb-16 sm:pb-24 px-4 sm:px-8 lg:px-16 overflow-hidden">
      ...
      <div className="max-w-7xl w-full mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-center text-center lg:items-start lg:text-left space-y-6 sm:space-y-8">
          <div className="space-y-1.5 sm:space-y-2 w-full reveal-left delay-1">
            <p className="text-xs sm:text-sm text-slate-500 font-bold tracking-widest uppercase reveal-up delay-1">
              Hi I am
            </p>
            <h1 className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[90px] font-black text-slate-950 tracking-tight leading-tight sm:leading-[0.95] reveal-up delay-2">
              Rijan Regmi
            </h1>
          ...
          <div className="flex items-center justify-center lg:justify-start gap-2.5 sm:gap-3 pt-1 w-full reveal-left delay-2">
            <a
          ...
          {/* Action Buttons Row */}
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-4 pt-1 w-full reveal-left delay-3">
            <a
              href="#contact"
          ...
          {/* Stats Bar */}
          <div className="pt-2 sm:pt-3 w-full flex justify-center lg:justify-start reveal-left delay-4">
        ...
        <div className="lg:col-span-5 flex justify-center items-center pt-4 lg:pt-0 reveal-right delay-2">
